  ...
  return (
    <main>
      ...
      <div className="landing-page__links">
        <div className="landing-page__links__groups">
        ...
        <div className="landing-page__links__events">
        ...
        <div className="landing-page__links__join">
          ...
          {sessionUser ?
            ...
            : <div className="landing-page__links__join__nonlink" style={{fontSize:'12pt'}}>Start a new group</div>
          }
