...
router.get('/group/:groupId', validateGroupId, requireAuth, requireCoHostAuth, async (req, res) => {
...
router.post('/group/:groupId', validateGroupId, validateVenueReqBody, requireAuth, requireCoHostAuthVenue, async (req, res) => {
